 ...
 *
 * 枚数は問わない（和了形の 14 枚でも聴牌形の 13 枚でも同じ数え方）。
 *
 * @param tehai - 手牌（純手牌 + 副露）
 */
export function listTehaiHais(tehai: Readonly<Tehai>): HaiKindId[] {
 ...
 */
export function countHaiInTehai(tehai: Readonly<Tehai>, id: HaiKindId): number {
