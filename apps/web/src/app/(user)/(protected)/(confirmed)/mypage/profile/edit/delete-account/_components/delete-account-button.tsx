  ...
  return (
    <>
      <button
        ...
        disabled={isDeleting}
        className="press-sm inline-flex items-center justify-center rounded-lg border-3 border-red-500 bg-white px-5 py-2 text-sm font-bold text-red-600 shadow-sm hover:bg-red-50 disabled:opacity-50"
      >
