...
import { MachiFuProblemListLoader } from "./machi-fu-problem-list-loader";
 ...
 */
export const MachiFuResultView = createCustomResultView({
  ProblemListLoader: MachiFuProblemListLoader,
