...
import { JantouFuProblemListLoader } from "./jantou-fu-problem-list-loader";
 ...
 */
export const JantouFuResultView = createCustomResultView({
  ProblemListLoader: JantouFuProblemListLoader,
