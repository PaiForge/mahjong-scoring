 ...
 *    出題された手牌と、成立していた役・自分が選んだ役を確認できる）
 * 4. 全期間リーダーボード上位3名を表示
 * 5. リーダーボード詳細ページへのリンク
 * 6. リトライボタンと練習一覧へのリンク
 */
...
import { YakuResultView } from "../_components/yaku-result-view";

const SLUG = PRACTICE_SLUG.yaku;
...
export default createPracticeResultPage(YakuResultView, { slug: SLUG });
