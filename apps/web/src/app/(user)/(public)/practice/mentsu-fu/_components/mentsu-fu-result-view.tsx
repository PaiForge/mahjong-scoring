...
import { MentsuFuProblemListLoader } from "./mentsu-fu-problem-list-loader";
 ...
 */
export const MentsuFuResultView = createCustomResultView({
  ProblemListLoader: MentsuFuProblemListLoader,
