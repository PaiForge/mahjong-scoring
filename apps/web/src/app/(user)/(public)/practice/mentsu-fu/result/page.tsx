...
import { MentsuFuResultView } from "../_components/mentsu-fu-result-view";

const SLUG = PRACTICE_SLUG.mentsuFu;
...
export default createPracticeResultPage(MentsuFuResultView, { slug: SLUG });
