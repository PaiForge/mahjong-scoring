 ...
 * `yakuDetails` は渡さない。
 *
 * 1級の試験と同じ牌姿を使う。この試験の違いは出題の広さであって盤面ではなく、
 * 「どんな手でも出る」ことは静止した1例では見せられない（文言が受け持つ）。
 */
 ...
 */
export async function ScoreExamHowToPlay() {
  const t = await getTranslations("scoreExamChallenge");
