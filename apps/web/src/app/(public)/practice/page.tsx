...
const drills: readonly DrillDef[] = [
  ...
  { href: "/practice/machi-fu/play/session", titleKey: "drills.machiFu.title", descriptionKey: "drills.machiFu.description", difficulty: "beginner", learnHref: "/learn/machi-fu" },
